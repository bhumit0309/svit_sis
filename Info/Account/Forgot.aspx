<%@ Page Title="Forgot password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Forgot.aspx.cs" Inherits="Info.Account.ForgotPassword" Async="true" %>
            ...
            <asp:PlaceHolder id="loginForm" runat="server">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:DropDownList ID="Role" runat="server" CssClass="form-control" Width="44%">
