<%@ Page Title="Manage Event Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageNotice.aspx.cs" Inherits="Info.Faculty.ManageNotice" %>
                                    ...
                                    <asp:GridView ID="Notice" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" PageSize="15"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Organized by">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label ID="txtAuthor" runat="server" CssClass="form-control" Text="Faculty" />
                                                </FooterTemplate>
                                            </asp:TemplateField>
